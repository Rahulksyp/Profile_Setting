...
public class RecommAdapter extends RecyclerView.Adapter<RecommAdapter.ViewHolder> {
    ArrayList<DummyDataModel> modelArrayList;
    Context context;

    public RecommAdapter(ArrayList<DummyDataModel> modelArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        DummyDataModel obj = modelArrayList.get(position);
